...
<<<<<<< .mine
					<div>
						...
						<div class="row pt-2" style="display: flex; flex-wrap: wrap;">
							<div class="form-check custom-checkbox mb-3 checkbox-danger"
								style="flex-basis: 25%; padding-right:10px; padding-left: 50px;">
								<input type="radio" class="form-check-input barColor"
									id="customRadioBox6" name="optradioCustom" data-value="red">
								<label class="form-check-label" for="customRadioBox6">빨강</label>
							</div>
							<div class="form-check custom-checkbox mb-3 checkbox-warning"
								style="flex-basis: 25%;">
								<input type="radio" class="form-check-input barColor"
									id="customRadioBox5" name="optradioCustom" data-value="orange">
								<label class="form-check-label" for="customRadioBox5">오렌지</label>
							</div>
							<div class="form-check custom-checkbox mb-3 checkbox-info"
								style="flex-basis: 25%;">
								<input type="radio" class="form-check-input barColor"
									id="customRadioBox3" name="optradioCustom" data-value="blue">
								<label class="form-check-label" for="customRadioBox3">파랑</label>
							</div>
							<div class="form-check custom-checkbox mb-3 checkbox-success"
								style="flex-basis: 25%;">
								<input type="radio" class="form-check-input barColor"
									id="customRadioBox4" name="optradioCustom" data-value="green">
								<label class="form-check-label" for="customRadioBox4">초록</label>
							</div>
						</div>
					</div>
